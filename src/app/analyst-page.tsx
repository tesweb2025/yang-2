      ...
      <main className="space-y-12 md:space-y-20">
        <section className="text-center">
            <h1 className="text-h1 font-bold tracking-tight mb-4">
              Lihat <span className="relative inline-block">Untung-Ruginya,
                <Image 
                  src="https://raw.githubusercontent.com/tesweb2025/Market-Intelligence-5.1/fa8791917ab4bd734591e1785cfedb13ce058170/perintilan%20web.png"
                  alt="Coretan"
                  width={300}
                  height={30}
