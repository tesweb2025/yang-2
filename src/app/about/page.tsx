        ...
        <div className="space-y-8">
          ...
          <Card>
            <CardContent className="space-y-4 text-body text-muted-foreground pt-6">
              <p>
                Awalnya, kami pikir semuanya udah siap. Produk udah dipoles, stok numpuk, feed Instagram rapi. Tinggal tunggu order masuk. Tapi pas launching? Sunyi. Gak ada suara. Gak ada transaksi.
              </p>
              <p>
